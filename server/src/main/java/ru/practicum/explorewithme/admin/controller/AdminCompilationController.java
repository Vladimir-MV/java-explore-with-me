    ...
    public class AdminCompilationController {
        ...
        public CompilationDto addCompilation(
            @Valid @RequestBody NewCompilationDto newCompilationDto) throws ConditionsOperationNotMetException {
        ...
        public void deleteEventInCompilation(
        ...
        public void updateEventInCompilation(
            @PathVariable Long compId,
            @PathVariable Long eventId) throws ObjectNotFoundException, RequestErrorException {
